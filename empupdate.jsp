<%-- 
    Document   : empupdate
    Created on : 15-Jun-2024, 2:09:10 pm
    Author     : mahen
--%>
...
<html>
    ...
    <body>
            ...
            <form method="post">
            Enter  a  Employee id<input type="post" name="t1"><!-- comment -->
...
st.execute("update emp45 set  name='"+b+"', salary='"+c+"',working='"+d+"',time='"+e+"'where id='"+a+"'");
System.out.print("valued updated");
